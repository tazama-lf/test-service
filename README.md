...
sequenceDiagram
    ...
    participant ADMIN as Test-Service    
...
#### URL
```
/v1/test/reports/getreportbymsgid
```
...
### Request Example
```http
GET /v1/test/reports/getreportbymsgid?msgid=1234567890 HTTP/1.1
```
...
##### a. `/v1/test/event-flow-control/entity`
##### b. `/v1/test/event-flow-control/account`
...
sequenceDiagram
  ...
  participant tmsapi as Test API
...
#### URL 1
```
/v1/test/event-flow-control/entity
```
#### Methods FOR URL 1
```
POST, GET, PUT
...
#### URL 2
```
/v1/test/event-flow-control/account
```
#### Methods FOR URL 2
```
POST, GET, PUT
...
```http
POST /v1/test/event-flow-control/entity HTTP/1.1
```
...
```http
POST /v1/test/event-flow-control/account HTTP/1.1
```
...
```http
PUT /v1/test/event-flow-control/cache HTTP/1.1
```
